...
namespace practica_2_de_Csharp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Curso desarrolloAppWeb = new Curso("desarrollo de aplicaciones web", 2, unProfesor);
            ...
            desarrolloAppWeb.cargarAlumno(juan);
            desarrolloAppWeb.cargarAlumno(jorge);
            desarrolloAppWeb.cargarAlumno(ariel);

            
            desarrolloAppWeb.mostrarDatos();
